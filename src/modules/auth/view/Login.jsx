...
export default function Login() {
    ...
    try {
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          email: user.email,
          uid: user.uid,
          role: role || "admin", // Default to admin if no role selected
        }),
      )
  ...
  const handleEmailPasswordAuth = async (e) => {
    ...
    try {
      ...
      setError(isSignUp ? "Gagal membuat akun: " + error.message : "Login gagal: " + error.message)
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-indigo-100 to-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 relative overflow-hidden">
        ...
        <img src="/img/sd8.jpg" alt="School" className="absolute inset-0 w-full h-full object-cover" />
        <div className="relative z-20 flex flex-col justify-center items-start p-12 text-white h-full">
          ...
          <p className="text-xl opacity-90 max-w-md">
            Platform manajemen pembelajaran untuk meningkatkan kualitas pendidikan
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">
              {isSignUp ? "Silakan buat akun untuk melanjutkan" : "Silakan login untuk melanjutkan"}
            </p>
          </div>
