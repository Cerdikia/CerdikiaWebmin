...
export default function AdminPage() {
  ...
  // Add this useEffect to load user data and teacher subjects
  useEffect(() => {
    ...
    // // Modify the existing useEffect that fetches mapel data to filter based on teacher subjects
    // useEffect(() => {
    //   if (mapel.length > 0 && userRole === "guru" && teacherSubjects.length > 0) {
    //     console.log("Filtering subjects for teacher")
    //     console.log("All subjects:", mapel)
    //     console.log("Teacher subjects:", teacherSubjects)
    //     // const filtered = mapel.filter((item) =>
    //     //   teacherSubjects.some((subject) => subject.id_mapel === item.id_mapel),
    //     // )
    //     const filtered = mapel.filter((item) =>
    ...
    //   } else {
    //     // For admin or if no teacher subjects, show all
    //     setFilteredMapel(mapel)
    //   }
    // }, [mapel, userRole, teacherSubjects])
